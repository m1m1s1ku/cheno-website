...
import { Elara, decodeHTML } from '../core/elara';
    ...
    private get _socialLinks(){
        ...
        <div class="social-menu">
            <svg id="facebook" @click=${() => {
                Elara().router.navigate('https://www.facebook.com/artistecheno');    
            ...
            <svg @click=${() => {
                Elara().router.navigate('https://www.instagram.com/valeriecheno');    
